...
function UserOptionsMenu({onClickCloseMenu}){
 ...
 //{toUpdate: {name, firstname, email, password, profile_picture}, login : {logEmail, logPassword}}
    ...
    return <Fragment>
            <ul className="list-unstyled mb-0 border border-primary rounded p-3 pe-5 mb-3 d-flex flex-column gap-3 position-relative">
            ...
            <ButtonClose onClick={onClickCloseMenu}/>
        </Fragment>
}
